...
#define simdutf_DOWN __riscv_vreinterpret_v_u32m4_u16m4
#define simdutf_UP __riscv_vreinterpret_v_u16m4_u32m4
  ...
  utf32 = __riscv_vmerge_vvm_u32m4(utf32, sur, m4, vl);
  /* compress and store */
  vbool4_t mOut = __riscv_vmor_mm_b4(__riscv_vmsne_vx_u16m4_b4(simdutf_DOWN(utf32), 0, vl*2), m4even, vl*2);
  utf32 = simdutf_UP(__riscv_vcompress_vm_u16m4(simdutf_DOWN(utf32), mOut, vl*2));
  vl = __riscv_vcpop_m_b4(mOut, vl*2);
  __riscv_vse16_v_u16m4(dst, simdutf_byteflip<bflip>(simdutf_DOWN(utf32), vl), vl);
  return vl;
#undef simdutf_DOWN
#undef simdutf_UP
};
